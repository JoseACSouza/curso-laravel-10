...
<form method="POST" action="{{route('incluirCliente')}}">
  ...
  <div class="col-auto mb-2">
    ...
    <input type="text" value="{{ old('endereco') }}" class="form-control @error('endereco') is-invalid @enderror" placeholder="Endereço" name="endereco">
  ...
  <div class="col-auto mb-2">
    ...
    <input type="text" value="{{ old('logradouro') }}" class="form-control @error('logradouro') is-invalid @enderror" placeholder="Logradouro" name="logradouro">
  ...
  <div class="col-auto mb-2">
    ...
    <input type="text" value="{{ old('cep') }}" class="form-control @error('cep') is-invalid @enderror" placeholder="CEP" name="cep">
    @if ($errors->has('cep'))
  ...
  <div class="col-auto mb-2">
    ...
    <input type="text" value="{{ old('bairro') }}" class="form-control @error('bairro') is-invalid @enderror" placeholder="Bairro" name="bairro">
